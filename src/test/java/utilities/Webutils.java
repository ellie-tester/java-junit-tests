...
public class Webutils {
    ...
    public static List<WebElement> waitForListElement(By locator, Duration timeout) {
       WebDriverWait wait = new WebDriverWait(driver, timeout);
    ...
    // Static method to take a screenshot of a web page
    public static void takeScreenshotOfWebElement(By locator) {
        ...
        try {
            FileUtils.copyFile(screenshot, destinationFile);
            System.out.println("Element screenshot saved: " + destinationFile.getAbsolutePath());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
